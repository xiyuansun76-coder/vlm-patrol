...
class Config:
    ...
    def __init__(self, config_path: str | Path | None = None):
        ...
        self.ptz_user = ptz.get("user", "") or os.environ.get("PTZ_USER", "admin")
        self.ptz_pass = ptz.get("pass", "") or os.environ.get("PTZ_PASS", "")
        ...
        mqtt = self._data.get("mqtt", sensor.get("mqtt", {}))
        self.mqtt_enabled = mqtt.get("enabled", False)
        self.mqtt_broker = mqtt.get("broker", "")
        self.mqtt_port = mqtt.get("port", 1883)
        self.mqtt_topics = mqtt.get("topics", [])
        self.mqtt_sensor_topic = mqtt.get("sensor_topic", "")
        self.mqtt_control_topic = mqtt.get("control_topic", "")
        self.mqtt_status_topic = mqtt.get("status_topic", "")
